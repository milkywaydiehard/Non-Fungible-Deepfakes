...
export default function Home() {
  ...
  // const [solanaProvider, setSolanaProvider] = useState(undefined);
  ...
  return (
    <>
      ...
      <VStack justifyContent="center" alignItems="center" h="100vh">
        ...
        {/* <HStack>
          {solanaProvider ? (
            <Button onClick={connectSolanaWallet}>Connect To Solana Wallet</Button>
          ) : (
            <Button onClick={() => {}}>Install Phantom</Button>
          )}
        </HStack> */}
        ...
        {/* {active && (
          <HStack>
            <Button onClick={getPublicKey}>Get Solana Public Key</Button>
          </HStack>
        )} */}
